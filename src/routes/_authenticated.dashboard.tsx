...
function DashboardPage() {
  ...
  return <AppShell title="Bookings & earnings" eyebrow="Live workspace">
    ...
    <section className="mt-5 grid gap-5 lg:grid-cols-2">
      <BookingList title="My customer bookings" empty="No bookings yet. Find a verified provider to get started." bookings={customerBookings} customer actions={(booking) => booking.status === "pending" ? <Button size="sm" variant="ghost" onClick={() => statusAction(booking.id,"cancelled")}>Cancel</Button> : null} />
